...
//para encontrar a flag, deve-se rodar este codigo modificando os valores que o server fornecer para descobrir as respostas, para acessar o server
// ==> nc nc titan.picoctf.net [porta fornecida pelo CTF]
